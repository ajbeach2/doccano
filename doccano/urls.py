...
from .views.server import ProjectView, DatasetView, DataUpload, LabelView, StatsView, GuidelineView, UsersView
from .views.server import ProjectsView, DataDownload
from .views.server import DemoTextClassification, DemoNamedEntityRecognition, DemoTranslation
...
urlpatterns = [
    ...
    path('v1/projects/<int:project_id>', ProjectDetail.as_view(), name='project_detail'),
    path('v1/projects/<int:project_id>/statistics',
         StatisticsAPI.as_view(), name='statistics'),
    path('v1/projects/<int:project_id>/labels',
         LabelList.as_view(), name='label_list'),
    path('v1/projects/<int:project_id>/label-upload',
         LabelUploadAPI.as_view(), name='label_upload'),
    path('v1/projects/<int:project_id>/labels/<int:label_id>',
         LabelDetail.as_view(), name='label_detail'),
    path('v1/projects/<int:project_id>/docs',
         DocumentList.as_view(), name='doc_list'),
    path('v1/projects/<int:project_id>/docs/<int:doc_id>',
         DocumentDetail.as_view(), name='doc_detail'),
    path('v1/projects/<int:project_id>/docs/<int:doc_id>/approve-labels',
         ApproveLabelsAPI.as_view(), name='approve_labels'),
    path('v1/projects/<int:project_id>/docs/<int:doc_id>/annotations',
         AnnotationList.as_view(), name='annotation_list'),
    path('v1/projects/<int:project_id>/docs/<int:doc_id>/annotations/<int:annotation_id>',
         AnnotationDetail.as_view(), name='annotation_detail'),
    path('v1/projects/<int:project_id>/docs/upload',
         TextUploadAPI.as_view(), name='doc_uploader'),
    path('v1/projects/<int:project_id>/docs/download',
         TextDownloadAPI.as_view(), name='doc_downloader'),
    path('v1/projects/<int:project_id>/roles',
         RoleMappingList.as_view(), name='rolemapping_list'),
    path('v1/projects/<int:project_id>/roles/<int:rolemapping_id>',
